---
title: "Lineamientos de Ciencia Abierta"
...
[^3]: Coordinador de Proyectos en **[COES](https://www.coes.cl/)**
...
### Gestión de un proyecto en OSF

Este apartado está destinado a ilustrar las potencialidades del OSF como repositorio para un proyecto de Tesis de Magister. Se ha elegido un proyecto de autoría propia que ha empleado datos de la primera ola (año 2016) de [ELSOC](http://www.elsoc.cl/) [@ELSOC2016b] .
...
<center>
![**Fig. 6**: Creación de componente en proyecto](images/osf-anim.gif)
...
Por otro lado, tenemos repositorios como **Dataverse Project** o **GitHub**, entre otros, los cuales ofrecen la utilidad de centralizar los archivos, así como también mantener un control de versiones y un flujo de trabajo cerrado (o no) para un equipo de colaboradores.

<div style="float:right; margin-left: 20px; margin-right: 0px;">
<caption>**Tabla 2**: Componentes de fuente de datos en Dataverse </caption>
| Component                                               |
|---------------------------------------------------------|
| Author name(s)                                          |
...
El [Dataverse Project](https://dataverse.org/) ofrece un **repositorio de datos abierto** y gratuito para la comunidad científica, el cual permite mantener un flujo de información constante entre Investigadores/as, Revistas, Instituciones y Desarrolladores. Al incrementar la visibilidad de las fuentes de datos al utilizar Dataverse, investigadores/as pueden obtener mayor reconocimiento por parte de la comunidad científica, así también es un medio a través del cual se puede obtener un identificador único que permite citar adecuadamente la base de datos.

<div style="float:left; margin-left: 0px; margin-right: 20px;">
  ![**Fig. 7**: ELSOC en Dataverse](images/dataverseelsoc.png){width=18em}
</div>

Desde el año 2018, el Centro de Estudios de Conflicto y Cohesión Social ha depositado dos bases de datos en [Dataverse](https://dataverse.harvard.edu/dataverse/coes_survey?q=&types=datasets&sort=dateSort&order=desc&page=1); la **Encuesta sobre Conflicto y Cohesion Social en Chile (2014)** [@ENACOES2014] y la primera ola del **Estudio Longitudinal Social de Chile (2016)** [@ELSOC2016b]. Ambas bases de datos se encuentran disponibles para libre descarga y son citables a través de un **DOI**. La Tabla 2 ilustra los siete componentes principales de una referencia para fuente de datos en Dataverse.

<br>

<div style="float:right; margin-left: 20px; margin-right: 0px;">
  ![**Fig. 8**: Github ](images/github.png){width=9em}
</div>

En segunda instancia, el OSF permite vincular un proyecto con un repositorio en GitHub. En principio, [GitHub](https://github.com/) está orientado a almacenar de proyectos a través del control de versiones basados en [Git ](https://es.wikipedia.org/wiki/Git) [^3]. Dentro de los posibles usos que se le pueden dar a GitHub, el principal ha sido el almacenamiento de código por parte de desarrolladores y programadores.

Desde el punto de vista de la apertura y la colaboración en Ciencias Sociales, el control de versiones basado en Git ofrece la oportunidad de guardar componentes específicos de un proyecto, tales como el código de análisis y documentos en **texto plano** [^4] .
